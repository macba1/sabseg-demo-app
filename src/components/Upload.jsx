...
const s = {
  page: { minHeight: '100vh', background: '#080d1a', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '32px 20px' },
  card: { maxWidth: '560px', width: '100%' },
  tag: { fontSize: '11px', letterSpacing: '3px', textTransform: 'uppercase', color: '#f87171', fontWeight: 700, marginBottom: '12px' },
  title: { fontSize: '32px', fontWeight: 300, color: '#fff', marginBottom: '8px', lineHeight: 1.2 },
  bold: { fontWeight: 700 },
  sub: { fontSize: '14px', color: '#64748b', lineHeight: 1.6, marginBottom: '32px' },
  dropzone: (active, hasFile) => ({
    border: `2px dashed ${active ? '#e94560' : hasFile ? '#166534' : '#1e293b'}`,
    borderRadius: '14px',
    padding: '28px 24px',
    textAlign: 'center',
    cursor: 'pointer',
    background: active ? '#e9456008' : hasFile ? '#0a291808' : '#0f172988',
    transition: 'all 0.2s ease',
    marginBottom: '12px',
  }),
  label: { fontSize: '11px', textTransform: 'uppercase', letterSpacing: '1.5px', color: '#64748b', marginBottom: '8px' },
  filename: { fontSize: '14px', color: '#4ade80', fontWeight: 600 },
  placeholder: { fontSize: '14px', color: '#475569' },
  hint: { fontSize: '12px', color: '#334155', marginTop: '4px' },
  btn: (enabled) => ({
    width: '100%', padding: '14px', borderRadius: '10px', border: 'none',
    background: enabled ? '#e94560' : '#1e293b', color: enabled ? '#fff' : '#475569',
    cursor: enabled ? 'pointer' : 'default', fontSize: '15px', fontWeight: 700,
    marginTop: '20px', transition: 'all 0.2s ease',
  }),
  demo: {
    width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid #1e293b',
    background: 'transparent', color: '#64748b', cursor: 'pointer', fontSize: '13px',
    fontWeight: 600, marginTop: '10px',
  },
  divider: { display: 'flex', alignItems: 'center', gap: '12px', margin: '20px 0' },
  line: { flex: 1, height: '1px', background: '#1e293b' },
  or: { fontSize: '12px', color: '#334155', textTransform: 'uppercase', letterSpacing: '1px' },
  error: { background: '#2d1215', border: '1px solid #991b1b', borderRadius: '10px', padding: '12px 16px', marginBottom: '16px', fontSize: '13px', color: '#f87171' },
}
