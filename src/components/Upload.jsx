  ...
  return (
    <div style={s.page}>
      <div style={s.card}>
        ...
        <DropZone label="Fichero A — Estadística de Venta" file={fileA} onFile={setFileA} />
        <DropZone label="Fichero B — Contabilidad" file={fileB} onFile={setFileB} />
        <DropZone label="Fichero C — Liquidaciones de aseguradoras" file={fileC} onFile={setFileC} optional />
        ...
        <button style={s.demo} onClick={onDemo}>Ver demo con datos de ejemplo</button>
        {onDemoTriangular && (
